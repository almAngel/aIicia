...
from .utils import interpolate_nans, seconds_to_srt_time
...
def align(
    ...
    for sdx, segment in enumerate(transcript):
        ...
        for sdx, (sstart, send) in enumerate(segment["sentence_spans"]):
            ...
            for word_idx in curr_chars["word-idx"].unique():
                ...
                # CHECK FOR WORDS IN SPOT (EDITED)
                if word_text in spot:
    ...
    print(f"Elapsed alignment time: {seconds_to_srt_time(diff)}")
